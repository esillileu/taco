...
def call_tool(state: RepoState, name: str, args: dict[str, Any]) -> dict[str, Any]:
    handlers = {
        ...
        "plan.intent.template": _plan_intent_template,
        "plan.intent.create_many": _plan_intent_create_many,
        "plan.intent.submit_many": _plan_intent_submit_many,
        ...
        "plan.mode.guide": _plan_mode_guide,
        "plan.design.submit_changes": _plan_design_submit_changes,
        "plan.task.submit_many": _plan_task_submit_many,
        "plan.task.template": _plan_task_template,
        "plan.task.frontmatter.sync": _plan_task_frontmatter_sync,
        "plan.task.lint": _plan_task_lint,
