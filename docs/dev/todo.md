...
> Tracking board for one-time planning tasks in `docs/dev/tasks/`.

## References

- [Documentation Guide](./docs.md) - task file contract and writing rules
- [Principles](./principles.md) - execution constraints
- [Plan](../plan.md) - SSOT roadmap source
